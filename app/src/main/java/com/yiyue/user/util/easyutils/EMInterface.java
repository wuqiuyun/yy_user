...
public interface EMInterface {
    ...
    void  deleteConversation(String imId);//删除一条聊天会话记录

    EMMessage sendOrderAddMoneyMes(SelfDefinedInfoBean chatNoFriendBean, String mChatId);

    //同意加价 且支付成功后 发送环信消息给对方
    void dealWithAddMoneyMes(Context context, String mChatId, String userid, String name, String path, String serviceName, Double money, String detailId, int msgStatus);//处理加价信息,同意或者拒绝
}
