...
import com.yiyue.user.databinding.ActivityUpdatePasswordBinding;
...
public class UpdatePasswordActivity extends BaseMvpAppCompatActivity<IUpdatePasswordView, UpdatePasswordPresenter> 
        implements ClickHandler , IUpdatePasswordView {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.tv_forget_password :      //忘记密码
                ...
                ForgetPasswordActivity.startActivity(this, ForgetPasswordActivity.class, bundle);
                finish();
                break;
