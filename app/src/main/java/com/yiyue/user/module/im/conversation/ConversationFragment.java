...
import com.yiyue.user.databinding.FragmentConversationBinding;
...
import com.yiyue.user.model.vo.bean.ConversationBean;
import com.yiyue.user.model.vo.bean.EventBean;
import com.yiyue.user.model.vo.bean.GroupJoinMemberBean;
...
import com.yiyue.user.module.im.daoutil.GroupDaoUtils;
import com.yiyue.user.module.im.daoutil.UserFriendDaoUtils;
import com.yiyue.user.module.im.imsearch.ImSearchActivity;
import com.yiyue.user.module.im.msgnotice.MsgNoticeActivity;
import com.yiyue.user.module.im.sysnotice.SysNoticeActivity;
...
import com.yiyue.user.widget.popwindow.XGravity;
import com.yiyue.user.widget.popwindow.YGravity;
...
//        initDBListener();
    ...
    private void showDeletePop(View view, String imId, int pos) {
        ...
        mDeletePop.showAtAnchorView(view, YGravity.BELOW, XGravity.CENTER);
    }
}
