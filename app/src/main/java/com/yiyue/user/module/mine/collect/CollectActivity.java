package com.yiyue.user.module.mine.collect;
...
import com.yiyue.user.databinding.ActivityMineCollectBinding;
import com.yiyue.user.model.constant.Constants;
import com.yiyue.user.module.mine.store.StoreFragment;
import com.yiyue.user.module.mine.stylist.MineStylistFragment;
...
public class CollectActivity extends BaseMvpAppCompatActivity<ICollectView, CollectPresenter> implements ICollectView {
    ...
    public static int FROMCOLLECTACTIVITY=1200;
    public static int COLLECTPAGE1=1201;
    public static int COLLECTPAGE2=1202;
    public static int COLLECTPAGE3=1203;
    ...
    private void setFragment() {
        ...
        fragments.add(MineStylistFragment.newInstance());
