...
import com.yiyue.user.databinding.ActivityMainBinding;
...
import com.yiyue.user.module.home.HomeFragment;
import com.yiyue.user.module.home.stylist.StylistActivity;
import com.yiyue.user.module.im.IMFragment;
import com.yiyue.user.module.im.imlogin.ImLoginManager;
import com.yiyue.user.module.mall.MallFragment;
import com.yiyue.user.module.mine.MineFragment;
...
import com.yiyue.user.util.NotificationsEnabledUtils;
import com.yiyue.user.widget.dialog.DialogUtil;
...
//                DLog.e("**************** main -- tableLayout-- onTabSelected : " + tab.getPosition());
                // 取消viewPage切换动画
...
//                }
        ...
        // 新人专享礼包
        if (CommonSharedPreferences.getInstance().getShowReward()) showWelfare();
    }
    ...
    private void showWelfare() {
        CommonSharedPreferences.getInstance().saveShowReward(false);
        String reward = FormatUtil.Formatstring(CommonSharedPreferences.getInstance().getBasicDataBean().getRegisterReward());
        DialogUtil.showRewardDialog(this, reward, new DialogUtil.ClickListenerInterface() {
            @Override
            public void doConfirm() {
                StylistActivity.startActivity(MainActivity.this, StylistActivity.class);
            }
        });
