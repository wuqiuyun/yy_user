package com.yiyue.user.module.mine.wallet.transfer;
...
import com.yiyue.user.databinding.ActivityTransferBinding;
...
import com.yiyue.user.module.im.recommend.GivenGiftActivity;
...
public class TransferActivity extends BaseMvpAppCompatActivity<ITransferView, TransferPresenter>
    ...
    private void initView() {
        ...
        mTransferBinding.tvDaibi.setText(String.format(getString(R.string.transfer_currency_price) , FormatUtil.Formatstring(CommonSharedPreferences.getInstance().getBasicDataBean().getSysCoinDefault())));
        mTransferBinding.etTransferNumber.setHint(String.format(getString(R.string.transfer_number_input) , FormatUtil.Formatstring(CommonSharedPreferences.getInstance().getBasicDataBean().getSysCoinDefault())));
