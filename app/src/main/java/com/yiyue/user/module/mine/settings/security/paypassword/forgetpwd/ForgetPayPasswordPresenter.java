...
public class ForgetPayPasswordPresenter extends BasePresenter<IForgetPayPasswordView>{
    ...
    public void checkCode(String mobile, String phoneCode, Context context) {
        ...
        new UserSmsApi().checkCode(mobile,"5", phoneCode, new YLRxSubscriberHelper<BaseResponse>(context,true) {
            @Override
    ...
    public void getPhoneCode(String mobile, Context context) {
        ...
        // 限制验证码获取
        startCountdownTime();
        new UserSmsApi().getPhoneCode(mobile, "2", new YLRxSubscriberHelper<BaseResponse>(context,true) {
            @Override
            public void _onNext(BaseResponse baseResponse) {
    ...
    public void checkSelfCode(String mobile, String phoneCode, Context context) {
        ...
        new UserSmsApi().checkCode(mobile,"3", phoneCode, new YLRxSubscriberHelper<BaseResponse>(context,true) {
            @Override
            public void _onNext(BaseResponse baseResponse) {
                getMvpView().onCodePhoneSuccess();
            }
    ...
    public void getSelfPhoneCode(String mobile, Context context) {
        // 限制验证码获取
        startCountdownTime();
        new UserSmsApi().getSelfPhoneCode(mobile, new YLRxSubscriberHelper<BaseResponse>(context,true) {
            @Override
            public void _onNext(BaseResponse baseResponse) {
                getMvpView().showToast("验证码获取成功");
            }
