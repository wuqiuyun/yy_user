...
import com.yiyue.user.model.vo.bean.ChatAdapterHolderbean;
import com.yiyue.user.model.vo.bean.ChatAdapterItemTypeBean;
import com.yiyue.user.model.vo.bean.ChatMoreChooseBean;
import com.yiyue.user.model.vo.bean.SelfDefinedInfoBean;
import com.yiyue.user.model.vo.bean.daobean.ChatNoFriendBean;
...
import com.yiyue.user.module.common.addr.AddressSelectActivity;
import com.yiyue.user.module.home.store.StoreManagerActivity;
import com.yiyue.user.module.im.chat.chatview.EmotiomComplateFragment;
import com.yiyue.user.module.im.chat.chatview.EmotionUtils;
import com.yiyue.user.module.im.chat.chatview.FragmentFactory;
import com.yiyue.user.module.im.chat.chatview.GlobalOnItemClickManagerUtils;
import com.yiyue.user.module.im.chat.chatview.ImVoiceRecorderView;
import com.yiyue.user.module.im.chat.chatview.NoHorizontalScrollerVPAdapter;
import com.yiyue.user.module.im.daoutil.ChatNoFriendDaoUtils;
import com.yiyue.user.module.im.daoutil.UserFriendDaoUtils;
import com.yiyue.user.module.im.friendinfo.FriendInfoActivity;
import com.yiyue.user.module.im.groupinfo.GroupInfoActivity;
import com.yiyue.user.module.im.recommend.RecommendFriendActivity;
import com.yiyue.user.module.im.redpacket.RedPacketSendActivity;
import com.yiyue.user.module.im.redpacket.reddetail.RedPacketDetailActivity;
import com.yiyue.user.module.im.transfer.TransferAccountsActivity;
import com.yiyue.user.module.im.transfer.transdetail.TransDetailActivity;
...
import com.yiyue.user.util.easyutils.EaseNotifier;
import com.yiyue.user.util.easyutils.EasyUtil;
                                    ...
                                    if (redItemFriendBean != null) {
                                        switch (redItemFriendBean.getDefinedMsgType()) {
                                            ...
                                            case 102://作品详情
                                                ...
                                                bundle.putString(Constants.OPUSID, redItemFriendBean.getDetailId() + "");
                                                bundle.putString(HEAD_PORTRAIT, redItemFriendBean.getToPath());
                                                bundle.putString(NICK_NAME, redItemFriendBean.getToNickname());
                                                WorksDetailsActivity.startActivity(getContext(), WorksDetailsActivity.class, bundle);
                                                break;
                                            case 103:
                                                //把美发师ID传入下个页面
                                                Bundle bundleSty = new Bundle();
                                                bundleSty.putString(STYLISTId, String.valueOf(redItemFriendBean.getDetailId()));
                                                StylistDetailsActivity.startActivity(getActivity(), StylistDetailsActivity.class, bundleSty);
                                                break;
                                            case 110://110.推荐好友
                                                Intent intent = new Intent(getActivity(), FriendInfoActivity.class);
                                                intent.putExtra(Constants.EXTRA_CHAT_TYPE, Constants.CHATTYPE_SINGLE);
...
//                            getActivity().startActivity(new Intent(getActivity(), RedPacketDetailActivity.class));
