...
import com.yiyue.user.util.MediaLoader;
import com.yiyue.user.util.easyutils.AppFrontBackHelper;
import com.yl.core.YLCore;
import com.yiyue.user.util.ClientUtil;
