...
import com.yiyue.user.model.vo.result.FindInviteResult;
import com.yiyue.user.model.vo.result.FindNextsResult;
import com.yiyue.user.model.vo.result.FindReCodeResult;
import com.yiyue.user.model.vo.result.FindRewardtypeResult;
import com.yiyue.user.model.vo.result.GetExplainResult;
...
public class RecomUserApi {
    ...
    public interface Api{
         ...
         * "userId": 0
         */
        @POST("/user-api/recomUser/bindInviteCode")
         ...
         * "userId": 0
         */
        @POST("/user-api/recomUser/changeType")
         ...
         * "userId": 0
         */
        @GET("/user-api/recomUser/findInvite")
         ...
         * "userId": 0
         */
        @POST("/user-api/recomUser/findNexts")
         ...
         * "userId": 0
         */
        @GET("/user-api/recomUser/findReCode")
         ...
         * @return
         */
        @POST("/user-api/recomUser/recommendUserIncome")
         ...
         * @return
         */
        @POST("/user-api/recomUser/recommendIncomeList")
         ...
         * @return
         */
        @POST("/user-api/recomUser/recommendIncomeByMonth")
