...
public class SettingsApi {
     ...
     * @param pwd
     */
    public void checkPassword(String pwd, YLRxSubscriberHelper<BaseResponse> subscriberHelper) {
        mApi.checkPassword(AccountManager.getInstance().getUserId(), pwd)
                .compose(RxSchedulers.rxSchedulerHelper())
                .compose(RxSchedulers.handleResult())
                .subscribe(subscriberHelper);
    }
