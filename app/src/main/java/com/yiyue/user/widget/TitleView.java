...
import com.yiyue.user.databinding.ViewTitleBinding;
...
public class TitleView extends LinearLayout {
    ...
    public void setSearch() {
        binding.trCenter.setVisibility(GONE);
    ...
    public void setCenterClickListener(@Nullable OnClickListener clickListener) {
        binding.rlSearch.setOnClickListener(clickListener);
    }
