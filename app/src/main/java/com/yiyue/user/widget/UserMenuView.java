...
import com.yiyue.user.databinding.ViewUserMenuBinding;
...
public class UserMenuView extends FrameLayout {
     ...
     * @param subTextSize
     */
    public void setSubContentSize(float subTextSize) {
        binding.tvContentSub.setTextSize(TypedValue.COMPLEX_UNIT_SP, subTextSize);
    }
