package com.yiyue.user.component.pay.imp;
...
import com.yiyue.user.component.pay.AliPayResult;
import com.yiyue.user.component.pay.PayHelper;
import com.yiyue.user.util.ActivityUtil;

import java.lang.ref.WeakReference;
import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;

import static com.yiyue.user.component.pay.PayHelper.PAYRESULT_FAILURE_UNKNOW_STR;
