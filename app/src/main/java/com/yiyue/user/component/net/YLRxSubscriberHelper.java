package com.yiyue.user.component.net;
...
import com.yiyue.user.component.net.interceptor.YLHttpLoggingInterceptor;
import com.yiyue.user.helper.AccountManager;
import com.yiyue.user.util.ThrowableUtil;
...
import static com.yiyue.user.component.net.interceptor.YLHttpLoggingInterceptor.FILTER_URLS;
    ...
    public void onError(Throwable throwable) {
         ...
         */
            ...
            apiException.message = BaseResponse.SUCCESS_CODE_ERROR_TOKEN_MESSAGE;
             onPermissionError(apiException);//TODO
            return;
        }
