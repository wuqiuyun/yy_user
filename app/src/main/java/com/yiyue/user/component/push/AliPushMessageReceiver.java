package com.yiyue.user.component.push;
        ...
        switch (Integer.valueOf(code)) {
            case 1://订单消息
                ...
                if (null != orderMessage) {
                    ...
                    if (orderMessage.getMsgtype() == 1){//接单成功

                    }else if (orderMessage.getMsgtype() == 2){//拒绝接单

                    }else if (orderMessage.getMsgtype() == 3){//预约时间快到了

                    }else if (orderMessage.getMsgtype() == 4){//预约时间到了

                    }else if (orderMessage.getMsgtype() == 5){//服务完成
                        EventBus.getDefault().post(new EventBean.ServiceComplete());
                    }else if (orderMessage.getMsgtype() == 6){//服务取消

                    }else if (orderMessage.getMsgtype() == 7){//当面付完成
